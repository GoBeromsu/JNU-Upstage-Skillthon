...
스킬을 발동하면 아래와 같은 형태의 한국어 마크다운 리포트가 생성됩니다. (실제 출력 형식을 따른 예시)
...
> - 차량: 스포티지 The SUV
> - 견적 총액: 1,070,883원
>   - 부품: 630,540원 / 공임: 342,990원
> - 검증 항목: 전체 15개 중 공임 6개, 부품 8개 비교 가능 (93%)
>
> **종합 판정**
>
> **🟡 다소 높음 (전체 편차 +9.4%)**
>
> > 일부 공임 항목이 시장 기준 대비 다소 높음. 정비소에 항목별 단가 확인을 권장합니다.
>
> **공임 비교**
>
> | 항목               | 견적 공임 | 공임나라 기준 | 편차   | 판정         |
> | ------------------ | --------- | ------------- | ------ | ------------ |
> | 브레이크 패드 교체 | 50,000원  | 42,000원      | +19.0% | 🟠 높음      |
> | 엔진오일 교환      | 35,500원  | 33,000원      | +7.6%  | 🟡 다소 높음 |
> | 오토매틱오일 교환  | 42,480원  | 41,000원      | +3.6%  | 🟢 적정      |
>
> **부품 비교**
>
> | 항목                               | 수량 | 견적 부품비 | 모비스 정가 | 편차   | 판정    |
> | ---------------------------------- | ---- | ----------- | ----------- | ------ | ------- |
> | 패드 키트-리어 디스크 (58302A3A00) | 1    | 37,100원    | 36,500원    | +1.6%  | 🟢 적정 |
> | 디스크-프론트 휠 (51712C1000)      | 2    | 110,400원   | 108,000원   | +2.2%  | 🟢 적정 |
> | 오일-엔진 (디젤)                   | 2    | 23,400원    | 28,000원    | -16.4% | 🔵 낮음 |
>
> **종합 제안**
>
> - 🟠 브레이크 패드 교체 공임이 시장 기준보다 +19% 높습니다. 정비소에 단가 근거를 요청하거나 다른 정비소와 비교 견적을 받아보세요.
> - 🔵 엔진오일은 시장가보다 낮은데, 호환·재생 부품일 가능성이 있으니 등급(순정/호환)을 확인하세요.
